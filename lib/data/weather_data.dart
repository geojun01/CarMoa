class WeatherData {
  ...
  final descriptionID = [201,200,202,210,211,212,221,230,231,232,
  ...
  final descriptionKR = ["가벼운 비를 동반한 천둥구름","비를 동반한 천둥구름","폭우를 동반한 천둥구름","약한 천둥구름",
    ...
    "소나기 눈","강한 소나기 눈","엷은 안개","연기","연무","모래 먼지","안개","모래","먼지","화산재","돌풍",
